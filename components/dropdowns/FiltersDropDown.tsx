...
const FiltersDropDown = (props: Props) => {
  return (
    <div className="group inline-block hover:bg-black-rgba text-[#495057]">
      <button className="outline-none focus:outline-none px-3 py-1  rounded-sm flex items-center">
        <FaFilter size={"0.75rem"} />
        <span className="pl-2 flex-1">Filters</span>
      </button>
      <ul
  ...
  "
          >
            ...
            <li className="px-3 py-1 hover:bg-gray-100">
              <select name="filters-operators1" className="w-full">
            ...
            <li className="px-3 py-1 hover:bg-gray-100">
              <span className="w-full">
                <select name="filters-operators2" className="w-full">
